...
SWEP.PrintName			= "Syringe Gun"		// 'Nice' Weapon name (Shown on HUD)	
...
killicon.Add("tf_weapon_syringegun_medic","sprites/bucket_syrgun_red",Color ( 255, 255, 255, 255 ) )

function SWEP:Initialize()
	local bucket = "red"
	if ValidEntity(self.Owner) and self.Owner:Team() == 1 then bucket = "blue" end
	self.WepSelectIcon		= surface.GetTextureID( "sprites/bucket_syrgun_" .. bucket )
end
