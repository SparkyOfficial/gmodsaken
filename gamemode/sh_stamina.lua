--[[
    ...
    Server-authoritative stamina system with efficient updates.
...
GM.StaminaSystem = {
    ...
    StaminaRegenRate = GM:GetConfig("Gameplay.Stamina.RegenRate", 2.5), -- Увеличено с 1.2 до 2.5 для очень быстрого восстановления
...
function GM:InitializeStamina(ply)
    ...
    ply.NextStaminaUpdate = CurTime() -- Для ограничения частоты обновлений
...
-- Хук PlayerTick для обновления стамины на сервере
if SERVER then
    hook.Add("PlayerTick", "GModsaken_StaminaTick", function(ply, mv)
