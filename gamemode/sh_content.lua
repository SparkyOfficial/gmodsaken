...
function GM:LoadCustomContent()
    if SERVER then
        ...
        util.PrecacheModel("models/player/gmodsaken/gordon/bms/gordon_survivor_player.mdl")
        util.PrecacheModel("models/player/gmodsaken/gordon/bms/c_arms_bms_hev.mdl")
        ...
        util.PrecacheModel("models/weapons/w_models/w_tf_shot.mdl")
