...
if CLIENT then
    ...
    include("core/cl_hud_components.lua")  -- HUD components
...
-- Отключение стандартных меню Garry's Mod
function GM:ShowTeam()
    -- Ничего не делать, чтобы стандартное меню команд на F2 не открывалось
    -- Сюда можешь вставить открытие своего меню
    return
end

function GM:ShowSpare1()
    -- Эта функция часто отвечает за F3. Оставь её пустой.
    return
end

function GM:ShowSpare2()
    -- Эта отвечает за F4. Оставь её пустой.
    return
end
