--[[
    GModsaken - Meat's Axe Weapon (Client)
...
hook.Add("Think", "GModsaken_UpdateAxeArms", function()
...
function SWEP:DrawHUD()
    ...
    draw.SimpleText("Топор Мясного", "DermaDefault", 20, screenH - 80, Color(255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    draw.SimpleText("Урон: " .. (self.Primary.Damage or 50), "DermaDefault", 20, screenH - 60, Color(255, 255, 0), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    draw.SimpleText("Заражение: создает хедкрабов", "DermaDefault", 20, screenH - 40, Color(150, 255, 150), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    draw.SimpleText("Лазер: R - мощный лазер", "DermaDefault", 20, screenH - 20, Color(255, 150, 150), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
end 